...
//Custom logo
export function Logo() { return <a className="logo" href="#/"><img src={`${import.meta.env.BASE_URL}media/logo.webp`} alt="OD YES AWARDS" fetchPriority="high" decoding="async" /></a>; }
